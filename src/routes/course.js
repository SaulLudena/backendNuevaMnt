...
const storage_course_images = multer.diskStorage({
  destination: function (req, file, cb) {
    if (file.fieldname === "imagen_principal_curso") {
      cb(null, "assets/images/course_images/");
    } else if (file.fieldname === "leccion_imagen") {
      cb(null, "assets/images/lesson_images/");
    }
  },
...
routes.post(
  ...
  async (req, res) => {
    try {
      ...
      console.log(data.modulos_curso.lessons);
      ...
      if (nuevamntToken !== undefined) {
        ...
        /*validamos que el arreglo de modulos esté lleno */
